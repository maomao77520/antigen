            ...
            <view class="flex-col section_1">
                ...
                <view class="flex-col group_9">
                    <view class="center-group justify-between">
                        ...
                        <input class="text_input" v-if="obj.phone.indexOf('*') != -1" type="text" maxlength="11" v-model="obj.phone" :disabled="disInput"
                               placeholder="请输入"/>
    ...
    export default {
        ...
        methods: {
            ...
            nextbtn() {
                ...
                uni.navigateTo({
                    url: '../comfirm_test/index' + this.parseParamsToStr({...this.obj, isOther: this.isme == 0})
                });
            },
